...
public class FontSizeProperty implements XlsxCellStyleProperty {
    ...
    public void accept(CellStyleBuilder builder) {
        builder.setFontHeightInPoints(Short.parseShort(value));
    }
    ...
    public boolean equals(Object o) {
        ...
        FontSizeProperty that = (FontSizeProperty) o;
